...
{
    private string sVer = "麦谷模拟登录 V1.0.2     ";
    ...
    //麦谷经纬度： 22.542949   113.925110
    //协议中是    22325769 113555066
    private int iLonPrefix = 11;
    private int iLonSuffix = 3555066;
    private int iLonChangeRangeMin = 300;
    private int iLonChangeRangeMax = 3000;

    private int iLatPrefix = 2232;
    private int iLatSuffix = 5769;
    private int iLatChangeRangeMin = -800;
    private int iLatChangeRangeMax = 800;
	...
	private void InitializeComponent()
	{
            ...
            this.label1.Location = new System.Drawing.Point(121, 417);
            ...
            // textBox5
            // 
            this.textBox5.Location = new System.Drawing.Point(177, 16);
            this.textBox5.Name = "textBox5";
            this.textBox5.Size = new System.Drawing.Size(63, 21);
            this.textBox5.TabIndex = 38;
            this.textBox5.Text = "113.92511";
            this.textBox5.Visible = false;
            // 
            // textBox6
            // 
            this.textBox6.Location = new System.Drawing.Point(177, 40);
            this.textBox6.Name = "textBox6";
            this.textBox6.Size = new System.Drawing.Size(63, 21);
            this.textBox6.TabIndex = 39;
            this.textBox6.Text = "22.542949";
    ...
    private string GetLon()
    {
        ...
        iLonSuffix += ran.Next(iLonChangeRangeMin, iLonChangeRangeMax);
        //满60分 进1度
        if (Convert.ToInt32((iLonSuffix.ToString().Substring(1, 1))) >= 6)
        {
            iLonSuffix = (Convert.ToInt32(iLonSuffix.ToString().Substring(0, 1))+1)*1000000 ;
        }
        //返回的经度为11351XXXXX
        return iLonPrefix.ToString() + iLonSuffix.ToString();
    }


    /*获取纬度*/
    //麦谷经纬度： 22.542949   113.92511
    //协议中是    22325769 113555066
    private string GetLat()
    {
        int iLat = new Random().Next(iLatChangeRangeMin, iLatChangeRangeMax);
 
        return iLatPrefix.ToString() + (iLatSuffix + iLat).ToString();
    }
    ...
    private string GetGpsParam()
    {
        ...
        return "&A" + GetHourMinSec() + GetLat() + GetLon() + "61000" + GetDayMonthYear();
    }
    ...
    private void trackBar1_Scroll(object sender, EventArgs e)
    {
        ...
        {
            iLonChangeRangeMin = 100;
            iLonChangeRangeMax = 1000;
        }
        else if (1 == trackBar1.Value)
        {

            iLonChangeRangeMin = 1000;
            iLonChangeRangeMax = 5000;
        }
        else if (2 == trackBar1.Value)
        {
            iLonChangeRangeMin = 5000;
            iLonChangeRangeMax = 10000;
        }
        //if (0 == trackBar1.Value)
        //{
        //    iLonPrefix = 11355;
        //    iLatPrefix = 2232;
        //    iLonChangeRangeMin = 1000;
        //    iLonChangeRangeMax = 9999;
        //}
        //else if (1 == trackBar1.Value)
        //{
        //    iLonPrefix = 1135;
        //    iLatPrefix = 223;
        //    iLonChangeRangeMin = 30000;
        //    iLonChangeRangeMax = 69909;
        //}
        //else if (2 == trackBar1.Value)
        //{
        //    iLonPrefix = 113;
        //    iLatPrefix = 22;
        //    iLonChangeRangeMin = 100000;
        //    iLonChangeRangeMax = 999999;
        //}
    }
